...
**API Documentation**\
To view the API documentation run the API main.py and go to this URL <http://127.0.0.1:8888>, **make sure you are logged in** and then go to this URL: <http://127.0.0.1:8888/docs>